...
vim new
:r while
echo "---------------------Format the xml file by adding proper spacing---------------------------------"
echo "---------------------Firstly delete all the spaces---------------------------------"
echo "---------------------Next add a space after </VirtualHost ---------------------------------"
sed ' /^\s*$/d;/^<\/VirtualHost/a \ ' ./files/virtualhost.conf
echo "------------------------------------------------------"
echo "------------------------------------------------------"
echo "------------------------------------------------------"
echo "------------------------------------------------------"
